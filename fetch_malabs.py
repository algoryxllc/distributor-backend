...
# Headers exactly as per MA Labs API document
ws.append([
    "list_no",
    "item_no",
    "upc_code",
...
# Get total count - no filters, get ALL items
first = requests.get(
...
while True:
    ...
    print(f"Page {page}/{total_pages} — {total_fetched} unique items fetched...")
...
print(f"\nDone! {total_fetched} unique items saved to malabs_catalog.xlsx")
